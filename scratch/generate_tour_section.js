...
function getNewSidebarMarkup(pkg) {
  ...
  return `<div class="sidebar-booking-card" style="position: sticky; top: 100px; background: #FFFFFF; border: 1px solid #E2E8F0; border-radius: 20px; padding: 24px; box-shadow: 0 10px 35px rgba(0,0,0,0.07); position: relative; overflow: hidden;">
              ...
              <div style="display: flex; align-items: baseline; gap: 6px; margin-bottom: 16px; flex-wrap: wrap;">
                <span style="font-size: 2.5rem; font-weight: 800; color: #0F172A; line-height: 1;">$${pkg.price.toLocaleString()}</span>
                <span style="font-size: 0.92rem; color: #64748B; font-weight: 500;">/ person</span>
                <a href="#section-itinerary" style="font-size: 0.92rem; color: #475569; font-weight: 600; text-decoration: underline; margin-left: 4px;">${pkg.days} days trip</a>
              </div>
              ...
              <div class="group-discount-content" style="display: none; margin-bottom: 18px; background: #F8FAFC; border-radius: 10px; padding: 12px; font-size: 0.85rem; border: 1px solid #E2E8F0;">
                <div style="display: flex; justify-content: space-between; padding: 4px 0; border-bottom: 1px solid #E2E8F0;">
                  ...
                  <strong style="color: #0F172A;">$${Math.round(pkg.price * 0.95).toLocaleString()} / person</strong>
                </div>
                <div style="display: flex; justify-content: space-between; padding: 4px 0; border-bottom: 1px solid #E2E8F0;">
                  <span style="color: #64748B;">5 - 8 Persons</span>
                  <strong style="color: #0F172A;">$${Math.round(pkg.price * 0.90).toLocaleString()} / person</strong>
                </div>
                <div style="display: flex; justify-content: space-between; padding: 4px 0;">
                  <span style="color: #64748B;">9+ Persons</span>
                  <strong style="color: #047857;">$${Math.round(pkg.price * 0.85).toLocaleString()} / person (Best Deal)</strong>
                </div>
              </div>

              <!-- Action Buttons -->
              <button class="btn open-inquiry-btn" data-trek-title="${pkg.title}" style="width: 100%; padding: 14px; background: #008060; color: #FFFFFF; border: none; border-radius: 50px; font-size: 1.05rem; font-weight: 800; cursor: pointer; margin-bottom: 12px; box-shadow: 0 4px 14px rgba(0, 128, 96, 0.25); transition: background 0.2s;">
                Book Now
              </button>
              <button class="btn open-inquiry-btn" data-trek-title="${pkg.title}" style="width: 100%; padding: 12px; background: #FFFFFF; color: #0F172A; border: 1px solid #CBD5E1; border-radius: 50px; font-size: 0.98rem; font-weight: 700; cursor: pointer; margin-bottom: 22px;">
                Make an Enquiry
              </button>
    ...
    <article itemscope itemtype="https://schema.org/TouristTrip">
      ...
      <section class="section-padding" style="padding-top: 20px;">
        <div class="container trek-detail-layout" style="display: grid; grid-template-columns: 2.2fr 1fr; gap: 40px;">
          ...
          <!-- Right Column: Sticky Booking Sidebar Widget (Matching Target Screenshot) -->
          <div style="min-width: 0;">
            ${getNewSidebarMarkup(pkg)}
          </div>
...
`;
  ...
  console.log(`Generated Tour Page with Updated Sidebar CTA Widget: tour/${pkg.slug}/index.html`);
});
